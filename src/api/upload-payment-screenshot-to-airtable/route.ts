...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const airtableRecordFields: FieldSet = {
      ...
      "Screenshot": cloudinaryUrl, // Send as a plain string for URL field type
    ...
    if (error.statusCode === 401 || error.statusCode === 403) {
      ...
      errorMessage = 'Airtable schema mismatch. Please check your column names (e.g., "Booking ID", "Screenshot" (as URL), "Original Filename", "Date") and their field types in your Airtable base.';
    }
